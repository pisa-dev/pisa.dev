        ...
        <CentralContent title="Codice di Condotta">
          <div>
            ...
            <p>
              ...
              <ul>
                <li>
                  Partecipa in modo autentico e attivo. Così facendo,
                  contribuisci alla salute e alla longevità di questa community
                </li>
                <li>
                ...
                <li>
                  Astenersi da comportamenti e discorsi avvilenti,
                  discriminatori o molesti.
                </li>
                <li>
                  Fai attenzione a ciò alle situazioni ed agli altri
                  partecipanti. Avvisa i responsabili della community se noti
                  una situazione pericolosa, qualcuno in difficoltà o violazioni
                  di questo codice di condotta, anche se sembrano irrilevanti.
                </li>
              </ul>
            </p>
            ...
            <p>
              ...
              <ul>
                <li>
                  Violenza, minacce di violenza o linguaggio violento ai danni
                  di altre persone
                </li>
                <li>
                  Battute e linguaggio sessista, razzista, omofobo, transfobico
                  o comunque discriminatorio.
                </li>
                <li>
                ...
                <li>
                  Pubblicare o minacciare di pubblicare informazioni di
                ...
                <li>
                  Contatto fisico inappropriato. È necessario avere il consenso
                  di qualcuno prima di toccarlo.
                </li>
                <li>
                ...
                <li>
                  Promozione o incoraggiamento di uno qualsiasi dei
