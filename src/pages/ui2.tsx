...
const stats = [
  { label: "Participants registered to our events", value: "44 million" },
  { label: "Members in our Telegram group", value: "450+" },
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 className="text-center text-lg font-semibold leading-8 text-black">
          We had {123} speakers, including from these amazing companies
        </h2>
