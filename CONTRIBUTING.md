...
Prima di contribuire a questa repository, per favore assicurarsi di discutere i cambiamenti che desideri fare creando una issue, mandando una email, o contattando uno dei maintainer in qualsiasi altro modo.

Per favore, assicurati di leggere il codice di comportamento che segue in questo documento.

## Pull Request Process

1. Assicurarsi di non pushare dipendenze di terze parti o altri artefatti.
2. Tenere il README.md aggiornato, a seconda delle modifiche effettuate (es.
   nuove variabili di ambiente, porte esposte, file di configurazione).
3. La tua pull request verrà mergiata non appena sarà controllata e approvata da
   almeno un maintainer.
...
community@pisa.dev. Tutti i reclami saranno esaminati ed indagati e daranno
